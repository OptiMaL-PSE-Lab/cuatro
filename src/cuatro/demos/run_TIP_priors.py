...
custom_params={'N_min_samples': N_min_s, 'init_radius': init_radius, 'explore': 'TIP', 'sampling': sampl}
...
custom_params={'N_min_samples': N_min_s, 'init_radius': init_radius, 'explore': 'TIP', 'sampling': sampl}
CUATRO_inst = CUATRO(**custom_params) # TODO: x0 is not used, another reason why x0 should be inside run_optimiser()
